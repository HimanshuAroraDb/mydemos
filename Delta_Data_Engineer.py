...
BLOB_ACCOUNT = "blobstor284281"
ACCOUNT_KEY = "vmp5WMf0nquoEKDW57+JjT/J+FNR2hARK0M+Hs+wPlkDtPx7V0HYiHW5yutlIFKiYea5UOgsO7XVaV513V34ZA=="
ADLS_CONTAINER = "adlscontainer"
ADLS_ACCOUNT = "adls233749"
...
# MAGIC %fs ls /mnt/adbquickstart/ADB-Quickstart/KKBox-Dataset/user_logs/unzipped/data/churn_comp_refresh

# COMMAND ----------

# MAGIC %fs head /mnt/adbquickstart/members/members_v3.csv
...
# MAGIC ))
# MAGIC 
# MAGIC val streamingDF = spark.readStream.format("com.databricks.spark.csv").schema(log_schema).option("mode","APPEND").load("dbfs:/mnt/adbquickstart/user_logs/")
...
# MAGIC     .option("checkpointLocation", "/mnt/adbquickstart/checkpoint") 
# MAGIC     .start("dbfs:/mnt/adbquickstart/bronze/user_logs/")

# COMMAND ----------

# MAGIC %fs
# MAGIC ls /mnt/adbquickstart/bronze
...
# MAGIC   USING DELTA 
# MAGIC   LOCATION 'dbfs:/mnt/adbquickstart/bronze/user_logs/'
...
# MAGIC members_gold.write.format('delta').mode('overwrite').save('/mnt/adbquickstart/gold/members/')
# MAGIC 
# MAGIC # Create SQL table
# MAGIC spark.sql(f"CREATE TABLE kkbox.members_gold USING delta LOCATION '/mnt/adbquickstart/gold/members/'") 
