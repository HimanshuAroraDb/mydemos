...
X_train, X_val, y_train, y_val = train_test_split(split_X, split_y, random_state=203014347, stratify=split_y)
...
xgbc_classifier = XGBClassifier(
  learning_rate=0.0012389452990588389,
  max_depth=9,
  min_child_weight=20,
  subsample=0.6454354459179592,
  random_state=968368840,
)
