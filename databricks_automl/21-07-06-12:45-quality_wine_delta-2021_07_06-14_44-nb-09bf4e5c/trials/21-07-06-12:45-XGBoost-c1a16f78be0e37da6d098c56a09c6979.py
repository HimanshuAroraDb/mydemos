...
X_train, X_val, y_train, y_val = train_test_split(split_X, split_y, random_state=856949073, stratify=split_y)
...
xgbc_classifier = XGBClassifier(
  learning_rate=0.24401455744331307,
  max_depth=11,
  min_child_weight=13,
  subsample=0.6567237013305647,
  random_state=748210865,
)
