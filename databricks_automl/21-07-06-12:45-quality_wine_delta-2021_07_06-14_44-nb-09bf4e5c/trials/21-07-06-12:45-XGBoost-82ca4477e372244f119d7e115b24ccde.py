...
X_train, X_val, y_train, y_val = train_test_split(split_X, split_y, random_state=475443256, stratify=split_y)
...
xgbc_classifier = XGBClassifier(
  learning_rate=0.013846138273950957,
  max_depth=10,
  min_child_weight=1,
  subsample=0.05490680849295969,
  random_state=95422502,
)
