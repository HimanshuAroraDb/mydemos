...
X_train, X_val, y_train, y_val = train_test_split(split_X, split_y, random_state=309637048, stratify=split_y)
...
xgbc_classifier = XGBClassifier(
  learning_rate=0.002353985236715858,
  max_depth=2,
  min_child_weight=12,
  subsample=0.6191175066981801,
  random_state=552983850,
)
