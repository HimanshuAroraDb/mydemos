...
X_train, X_val, y_train, y_val = train_test_split(split_X, split_y, random_state=887682904, stratify=split_y)
...
xgbc_classifier = XGBClassifier(
  learning_rate=0.0067201733962361804,
  max_depth=8,
  min_child_weight=17,
  subsample=0.28064318356508866,
  random_state=54524384,
)
