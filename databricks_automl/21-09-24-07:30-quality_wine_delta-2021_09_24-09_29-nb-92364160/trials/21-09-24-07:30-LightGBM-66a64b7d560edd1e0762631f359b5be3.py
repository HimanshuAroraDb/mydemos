...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.5559980205044804,
  lambda_l1=615.5206125752081,
  lambda_l2=0.12440130197265462,
  learning_rate=0.47652849957258614,
  max_bin=32,
  min_child_samples=6,
  n_estimators=16294,
  num_leaves=660,
  subsample=0.7958786756841314,
