...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.04330913797327058,
  lambda_l1=8.916151084553176,
  lambda_l2=0.0013220125703139218,
  learning_rate=0.06345032405707203,
  max_bin=8,
  min_child_samples=16,
  n_estimators=624,
  num_leaves=46,
  subsample=0.5686099288424384,
