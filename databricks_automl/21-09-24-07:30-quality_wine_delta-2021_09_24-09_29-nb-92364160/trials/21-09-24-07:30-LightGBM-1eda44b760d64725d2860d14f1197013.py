...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.6319335244185856,
  lambda_l1=0.0012668775871193267,
  lambda_l2=595.0899836768666,
  learning_rate=0.01014836678647247,
  max_bin=32,
  min_child_samples=40,
  n_estimators=15,
  num_leaves=9691,
  subsample=0.48294745165383857,
