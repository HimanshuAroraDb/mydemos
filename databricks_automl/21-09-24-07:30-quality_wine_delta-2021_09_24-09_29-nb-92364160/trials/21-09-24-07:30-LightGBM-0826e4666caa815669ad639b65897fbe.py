...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/1997345829032135/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
...
mlflow.set_experiment("/Users/himanshu.arora@databricks.com/databricks_automl/quality_wine_delta-2021_09_24-09_29")
...
input_data_path = input_client.download_artifacts("29c8d11e838840cfb1f7d6e57d002878", "data", input_temp_dir)
...
transformers.append(("numerical", SimpleImputer(strategy="mean"), ['alcohol', 'chlorides', 'citric_acid', 'density', 'fixed_acidity', 'free_sulfur_dioxide', 'pH', 'residual_sugar', 'sulphates', 'total_sulfur_dioxide', 'volatile_acidity']))
...
X_train, X_val, y_train, y_val = train_test_split(split_X, split_y, random_state=840840065, stratify=split_y)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/1997345829032135/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
...
lgbmc_classifier = LGBMClassifier(
  colsample_bytree=0.20985941972815675,
  lambda_l1=305.4753275708991,
  lambda_l2=0.0025262631388222783,
  learning_rate=0.007435729678452052,
  max_bin=4,
  min_child_samples=3,
  n_estimators=46,
  num_leaves=8522,
  subsample=0.8212787230195201,
  random_state=840840065,
)
