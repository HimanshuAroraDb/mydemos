...
dev_scoring_uri = "<webservice endpoint url>"
...
attach_config = AksCompute.attach_configuration(resource_group="<rg>", cluster_name=cluster_name)
...
prod_scoring_uri = "<webservice endpoint url>"
prod_service_key = "<authentification key>"
