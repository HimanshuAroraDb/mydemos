...
val streamA = "streamA_si"
val streamB = "streamB_si"

// COMMAND ----------

val writePath =      workingDir + "/output.delta"
val checkpointPath = workingDir + "/output.checkpoint"
...
// TODO
val activityPath   = workingDir + "/activityCount.delta"
val checkpointPath = workingDir + "/activityCount.checkpoint"
...
val batchDF = spark.read.format("delta").load(activityPath)
display(batchDF)
