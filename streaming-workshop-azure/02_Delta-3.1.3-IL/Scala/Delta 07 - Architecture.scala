...
val bronzePath           = workingDir + "/wikipedia/bronze.delta"
val bronzeCheckpointPath = workingDir + "/wikipedia/bronze.checkpoint"

val silverPath           = workingDir + "/wikipedia/silver.delta"
val silverCheckpointPath = workingDir + "/wikipedia/silver.checkpoint"
...
val bronzeStreamName = "bronze_stream_si"
val silverStreamName = "silver_stream_si"
val goldStreamName = "gold_stream_si"
...
val bronzeDF = spark.sql(s"SELECT * FROM delta.`$bronzePath` limit 1")
display(bronzeDF)
